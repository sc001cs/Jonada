...
<div class="container">
    ...
    <form class="form-signin" method="post" action="createNewUser.php">
        ...
        <span><b><p class="alert alert-success">Lecturer Code</p></b><input type="text" class="input-block-level" name="studentcode" required></span>
        
        <button style="float: right;" class="btn btn-large btn-primary" type="submit">Submit</button>
        <p  class='table' ><a class='btn btn-info btn-large' href='welcome.php'>Back</a></p>
    </form>
