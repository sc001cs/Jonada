...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_num_rows($r) > 0){
        ...
        $sqlUpdate = "insert into student_lecturer "
                . " (username, password, fullname, email, islecturer) "
                . " values('$username', sha1('$password'), '$fullname', '$email', '1')";
...
<div class="container">
    ...
    <form class="form-signin" method="post" action="createNewLecturer.php">
